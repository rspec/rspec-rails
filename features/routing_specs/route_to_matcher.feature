Feature: route_to matcher
  ...
  Scenario: passing route spec with hyper shortcut syntax
    Given a file named "spec/routing/widgets_routing_spec.rb" with:
      ...
      describe "routes for Widgets" do
        ...
        put("/widgets/0").should route_to "widgets#update", :id => "0"
        delete("/widgets/0").should route_to "widgets#destroy", :id => "0"
      end
      """
  ...
  Scenario: failing route spec with hyper shortcut syntax
    Given a file named "spec/routing/widgets_routing_spec.rb" with:
      ...
      describe "routes for Widgets" do
        get("/widgets").should_not route_to "widgets#index"
        post("/widgets").should_not route_to "widgets#create"
        put("/widgets/0").should_not route_to "widgets#update", :id => "0"
        delete("/widgets/0").should_not route_to "widgets#destroy", :id => "0"
      end
      """
